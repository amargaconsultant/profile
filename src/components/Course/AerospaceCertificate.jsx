...
import {listDataAerospace} from './DataCertificate'





export default function AerospaceCertificate() {
    // File path.
  ...
  const toggle = tab => {
    ...
    function renderContent(){
        var abjad = listDataAerospace[0]["Name"][0]
        var nama = listDataAerospace[0]["Name"]
        var accordionitem = []
        var tabData = []
        var rowDataPerName = []
        
        listDataAerospace.map((item,index)=>{
            if(item["Name"]!=nama){
                accordionitem.push(
            ...
            if(index+1==listDataAerospace.length){
                accordionitem.push(
